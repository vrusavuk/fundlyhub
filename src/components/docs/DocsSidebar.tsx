...
export function DocsSidebar() {
  ...
  return (
    <div className="fixed top-14 sm:top-16 left-0 w-64 h-[calc(100vh-3.5rem)] sm:h-[calc(100vh-4rem)] border-r border-border bg-background/95 backdrop-blur-sm overflow-y-auto z-50">
      <div className="p-4">
