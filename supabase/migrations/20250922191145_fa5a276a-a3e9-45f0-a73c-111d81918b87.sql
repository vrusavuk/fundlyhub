-- Insert sample data for testing social features (fixed enum values)
...
VALUES 
  ('11111111-1111-1111-1111-111111111111', 'Red Cross International', 'Red Cross', 'https://redcross.org', 'United States', ARRAY['Medical', 'Emergency'], 'approved'),
  ('22222222-2222-2222-2222-222222222222', 'Save the Ocean Foundation', 'Ocean Savers', 'https://saveocean.org', 'Canada', ARRAY['Environment', 'Animal'], 'approved'),
