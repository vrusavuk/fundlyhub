...
export function DocsSidebar() {
  ...
  return (
    <div className="w-64 border-r border-border bg-background/95 backdrop-blur-sm fixed top-14 sm:top-16 left-0 h-[calc(100vh-3.5rem)] sm:h-[calc(100vh-4rem)] overflow-y-auto z-30">
      <div className="p-4">
