...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "h-[44px] border-b border-[#E3E8EE] transition-colors hover:bg-[#FAFBFC]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-[44px] px-4 text-left align-middle text-[12px] font-semibold uppercase tracking-[0.5px] text-[#425466]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "h-[44px] px-4 align-middle text-[14px] font-normal text-[#0A2540]",
      className
    )}
    {...props}
  />
