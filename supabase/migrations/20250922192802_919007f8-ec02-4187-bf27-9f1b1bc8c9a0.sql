...
('11111111-1111-1111-1111-111111111111', 'Sarah Johnson', 'sarah.johnson@example.com', 'Passionate about animal welfare and environmental conservation. Working to make the world a better place for all living beings.', null, 'creator', 'San Francisco, CA', 'https://sarahjohnson.org', 0, 0, 0, 0),
('22222222-2222-2222-2222-222222222222', 'Michael Chen', 'michael.chen@example.com', 'Healthcare advocate focused on improving medical access in underserved communities. Former nurse turned full-time organizer.', null, 'creator', 'Seattle, WA', null, 0, 0, 0, 0),
('33333333-3333-3333-3333-333333333333', 'Emma Rodriguez', 'emma.rodriguez@example.com', 'Education enthusiast working to provide learning opportunities for children in low-income areas.', null, 'creator', 'Austin, TX', 'https://eduforall.org', 0, 0, 0, 0),
('44444444-4444-4444-4444-444444444444', 'David Kim', 'david.kim@example.com', 'Emergency response coordinator helping communities recover from natural disasters.', null, 'creator', 'Los Angeles, CA', null, 0, 0, 0, 0);
