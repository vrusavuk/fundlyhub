...
export function DocsSidebar() {
  ...
  return (
    <div className="fixed top-16 sm:top-18 left-0 w-64 h-[calc(100vh-4rem)] sm:h-[calc(100vh-4.5rem)] border-r border-border bg-background/95 backdrop-blur-sm overflow-y-auto z-30">
      <div className="p-4">
